    ...
    <section className="flex flex-col items-center gap-5">
        ...
        <div className="w-[80%] h-fit flex flex-col items-center p-10 rounded-md shadow-lg shadow-[#2f3e46] bg-[#52796f]/20">
          ...
          <div className="w-full flex flex-col items-center mt-10 gap-5">
            ...
            <div className="flex flex-col gap-5">
              ...
              <div>
                <h3 className="font-Dm-Serif-Display text-xl">
                  Dm Serif Display
                </h3>
                <p className="font-Dm-Serif-Display">
      ...
      <section id="preview" className="min-h-screen max-w-[90%]">
        <div className="flex flex-col items-center gap-5 p-10 rounded-md shadow-lg shadow-[#2f3e46] bg-[#52796f]/20">
          ...
          <a
            href="https://holidaaze.netlify.app/"
            target="_blank"
            ...
            <div className="max-w-[90%] hidden md:block">
              <img
                src="https://i.imghippo.com/files/Kewi1777Xv.png"
                alt="Image"
              />
            </div>
          </a>
      ...
      <section
        ...
        <div className=" h-[80%] p-10 rounded-md shadow-lg shadow-[#2f3e46] bg-[#52796f]/20">
          ...
          <article className="pt-2 px-5 max-h-100 md:max-h-full overflow-auto border border-[#84a98c] rounded-md">
            Holidaze is my take on the second project exam. We were tasked with
            creating a site for the venue booking company called Holidaze.
            <br />
            <br />
            Visitors had to be able to view venues and the eventual free dates
            for a booking.
            <br />
            The customers are able to book a venue as well as edit their
            profile.
            <br />
            When creating an account, or while editing, a customer can choose to
            become a so called venue manager. Venue managers can create, edit
            and delete venues, as well as view upcoming bookings on their
            venues. In addition they have the same functions as a regular
            customer.
            <br />
            <br />
            One thing to remember when viewing the site is that there is no
            useAuth() hook.
            <br />
            This results in the user having to manually reload the page to get
            the correct header. This will be patched at a later date.
            <br />
            <br />
            This project was built using Typescript and TailwindCSS. Creating
            Holidaze with typescript was challenging, and the project taught me
            a lot about both typescript and Tailwind, as well as how I prefer to
            work as a developer.
          </article>
          <div id="links" className="h-30 flex flex-col items-center pt-10">
            <div className="grid grid-cols-4 w-[95%] h-fit justify-items-center">
              ...
              <a
                href="https://www.figma.com/design/W0i1GniltMtpAwmHtziQYH/PE2-HiFi?node-id=204-1081&t=4RpVkBRrNoGi3uj6-1"
                className=" h-20 flex flex-col items-center text-xs"
                target="_blank"
                rel="noopener norefferer">
