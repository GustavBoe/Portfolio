     ...
     <section id="styleguide" className="min-h-screen pt-10 w-full flex flex-col items-center justify-between">
           <div className="w-[80%] h-fit flex flex-col items-center p-10 rounded-md shadow-lg shadow-[#2f3e46] bg-[#52796f]/20">
              ...
              <div className="w-full flex flex-col items-center mt-10 gap-5">
               ...
               <p className="font-Commissioner">Aa Bb Cc Dd Ee Ff Gg 1234567890</p>
      ...
      <section id="preview" className="min-h-screen max-w-[90%]">
         ...
         <a href="https://github.com/GustavBoe/sp2" 
         target="_blank" 
         rel="noopener norefferer"
         className="flex flex-col items-center"
         > {/*Image container */}
          <div className="max-w-[90%] md:hidden">
           <img src="https://i.imghippo.com/files/BPVn8874ek.png" alt="compressed_2_compressed_1780396539238_pe4t09xzlas" />
          </div>
            
           <div className="max-w-[90%] hidden md:block">
             <img src="https://i.imghippo.com/files/BCJq3615eKE.png" alt="Image"/>
           </div>
     ...
     <section id="description" className="min-h-screen w-[80%] mx-auto pt-2 flex flex-col items-center gap-5">
           <div className=" h-[80%] p-10 rounded-md shadow-lg shadow-[#2f3e46] bg-[#52796f]/20">
             ...
             <article className="pt-2 px-5 max-h-100 md:max-h-full overflow-auto border border-[#84a98c] rounded-md">
              List is my take on the task presented for the course Semester Project 2. 
              <br/>
              The task was to build an auction site where the visitors could view listings,
               and users could post,edit and delete listings as well as bid on listings by other users.
              <br/> 
              ...
              <br/>
              Using Tailwind made it possible for me to realize my vision for the site. 
              If I were to improve the site, I would change the errorhandling and alerts, as well as make the site a React.js application.
         ...
         <a href="https://gustavboe.github.io/sp2/"
           className="flex flex-col items-center"  
           target="_blank" 
           rel="noopener norefferer">
