...
export default function CssFrameworks(){
  ...
  return(
    <section className="flex flex-col items-center gap-5">
      ...
      <a href="https://github.com/GustavBoe/JavaScript2Fall25_StillApp/tree/css-frameworks" 
      target="_blank" 
      rel="noopener norefferer"
      className="flex flex-col items-center"
      > {/*Image container */}
       <div className="max-w-[90%] md:hidden">
        <img src="https://i.imghippo.com/files/Tdu6746ZN.png" alt="compressed_0_compressed_1780396539238_hzivvotg9j" />
       
       </div>
         
        <div className="max-w-[90%] hidden md:block">
          <img src="https://i.imghippo.com/files/EiVo3506nU.png" alt="compressed_0_compressed_1780396768538_qeyfj276o08" />
        </div>
      ...
      <section id="description" className="min-h-screen w-[80%] mx-auto pt-2 flex flex-col items-center gap-5">
        <div className=" h-[80%] p-10 rounded-md shadow-lg shadow-[#2f3e46] bg-[#52796f]/20">
          ...
          Still is my take on an assessment given in the course Javascript 2, and continued in CSS Frameworks. 
          The task was to create a photograpy sharing app using Javascript and styling it with a css framework.
          For this project I wanted to create a minimalistic app/site with the post from the users being the main focal point.
          I originally picked Bootstrap as my framework, but I quickly realized that TailwindCSS would have been a better fit for my vision.
           This project taught me that I prefer to style my own components.
          </article>
        <div id="links" className="h-30 flex flex-col items-center">
      <div className="grid grid-cols-2 w-[95%] h-fit justify-items-center">
      <a href="https://github.com/GustavBoe/JavaScript2Fall25_StillApp/tree/css-frameworks" 
