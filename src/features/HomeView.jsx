...
export default function HomeView(){
 ...
 <button className="fixed pt-70 bottom-10 right-10 hover:cursor-pointer" onClick={() => scrollToSection('top')}>{<ArrowUp className="border-2 border-[#cad2c5] text-[#cad2c5] w-7 h-7 rounded-sm"/>}</button>
        <section id="introduction" className="min-h-screen w-[80%] max-w-250">
          <div className="flex flex-col md:flex-row md:pt-50 md:gap-5 items-center">
        ...
        <img src="https://i.imghippo.com/files/SM8096ys.jpeg" alt="IMG_9270" className="object-bottom h-70 w-70 "/>
          ...
          <article className="p-5 gap-5 rounded-md shadow-lg shadow-[#2f3e46] bg-[#52796f]/20">
           <h3>About me</h3>
           <p>I am a 26 year old, newly educated frontend developer, based in Bergen together with my two lovely kids and girlfriend</p>
           <p>For my projects, I strive to create websites with clean designs and great UI/UX</p>
          </article>
          </div>
        </div>
        <div className=" hidden md:block rounded-[40%] border-5 border-[#cad2c5] overflow-clip">{/*Image container desktop*/}
        <img src="https://i.imghippo.com/files/SM8096ys.jpeg" alt="IMG_9270" className="object-center w-150  "/>
        </div>
        ...
        <section id="projects" className="flex flex-col items-center w-full ">{/*Projects container */}
          ...
          <div className="w-full h-10 from-[#354f52] to-white to-15% bg-linear-to-b ">
            ...
            <div className="flex flex-col items-center text-center w-full bg-white text-black">{/*CSS Frameworks*/}
              ...
              <div className={viewProject !== "frameworks" ? "hidden": " flex flex-col items-center w-full gap-5"}>
                <div className="h-50 md:w-200 overflow-clip md:overflow-auto border-y-2">{/*Image container*/}
                  <img src="https://i.imghippo.com/files/ZD7102TJs.png" alt="Css Frameworks preview" className="md:hidden"/>
                  <img src="https://i.imghippo.com/files/IRJC9593T.png" alt="compressed_0_compressed_1780388720612_hgrfw4hvxie" className="hidden md:block"/>
                </div>
                <div className="flex flex-col items-center w-full gap-5">{/*Text container*/}
                  ...
                  <article className="text-left md:text-center text-sm w-[90%]">A course assignement where the main goal was to style a couple of pages using a css framework of our choosing. </article>
                </div>
       ...
       <div className="flex flex-col items-center text-center w-full bg-[#366aa5] text-white">{/*Semester project*/}
              ...
              <div className={viewProject !== "project" ? "hidden": " flex flex-col items-center w-full gap-5"}>
                <div className="h-50 md:w-200 overflow-clip md:overflow-auto border-y-2">{/*Image container*/}
                   <img src="https://i.imghippo.com/files/TnbA2911foY.png" alt="Semester project preview" className="md:hidden"/>
                   <img src="https://i.imghippo.com/files/byzK2264kJE.png" alt="compressed_1_compressed_1780388720612_ty9dewpi3df" className="hidden md:block"/>
                </div>
                <div className="flex flex-col items-center w-full gap-5">{/*Text container*/}
       ...
       <div className="flex flex-col items-center text-center w-full bg-[#005455] text-white">{/*Project Exam*/}
              ...
              <div className={viewProject !== "exam" ? "hidden": " flex flex-col items-center w-full gap-5"}>
                <div className="h-50 md:w-200 overflow-clip md:overflow-auto border-y-2">{/*Image container*/}
                   <img src="https://i.imghippo.com/files/xZVy5304GS.png" alt="Project exam preview" className="md:hidden"/>
                   <img src="https://i.imghippo.com/files/TdIV7114kuw.png" alt="compressed_2_compressed_1780388720612_xmfpl2o4gct" className="md:block"/>
                </div>
                <div className="flex flex-col items-center w-full gap-5">{/*Text container*/}
